        ...
        {!isOpened && (
          <>
            <ul className="menu bg-base-200 rounded-box w-56">
              ...
              <li>
                <Link to={"/test"} className="btn border-0">Test</Link>
              </li>
              <li>
                <details>
