...
function App() {
  ...
  const settings = {
    ...
    destination: "http://localhost:5000/upload/007",
    destinationheaders: {
      Method: "POST",
    },
  ...
  return (
    <>
          ...
          <div key={"normal images"}>
            {fileNames?.map((file, index) => {
              return (
                  ...
                  <img
                    key={index+1}
                    src={`http://localhost:5000/images/${file.filename.replace(
                      ".tif",
                      ".jpg"
                    )}`}
            ...
            {fileNames?.map((file, index) => {
              return (
                <>
                  ...
                  <img key={index} src={`http://localhost:5000/B&Wimages/${file.filename.replace(".tif",".jpg"
                    )}`}
                    className="w-[750px] h-[300px]"
                  ></img>
                </>
      ...
      <div className="p-2 -mt-[700px]">
      <h1 className="text-2xl">Scanned Data:</h1>
      {text.map((line, index) => {
